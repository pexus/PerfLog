...
import org.perf.log.filter.sql.SQLInterceptorSpyLogDelegator;
 ...
 * @author Arthur Blake
 * 
 * Modified for org.perf.log.* project 
 * to plug-in SQLInterceptorSpyLogDelegator() instead of SLF4JSpyDelegator
 * There is no dependency on SLF4J. Applications can use any logger. A sample application 
 * logger with hooks to PerfLog is provided in the AppLogger project
 *  
...
public class SpyLogFactory
{
   ...
   */
  private static final SpyLogDelegator logger = new SQLInterceptorSpyLogDelegator(); 
	  										// new Slf4jSpyLogDelegator();
